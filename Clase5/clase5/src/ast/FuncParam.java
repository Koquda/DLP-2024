...
/*
	funcParam -> name:string type:type
*/
public class FuncParam extends AbstractAST  {
	...
	public FuncParam(Object name, Object type) {
		super();
    ...
    public String toString() {
        return "FuncParam{" + " name=" + this.getName() + " type=" + this.getType() + "}";
    }
