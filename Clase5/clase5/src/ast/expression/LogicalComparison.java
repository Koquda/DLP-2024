...
/*
	...
	expression -> 
*/
public class LogicalComparison extends AbstractExpression  {
	...
	public LogicalComparison(Expression left, String operator, Expression right) {
		super();
	...
	public LogicalComparison(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "LogicalComparison{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
