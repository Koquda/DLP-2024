...
public class ArithmeticComparison extends AbstractExpression  {
	...
	public ArithmeticComparison(Expression left, String operator, Expression right) {
		super();
	...
	public ArithmeticComparison(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "ArithmeticComparison{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
